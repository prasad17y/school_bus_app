...
const render_index = require('../controller/render_index')
const render_test = require('../controller/render_test')
...
module.exports= function(app){
	...
	app.get('/render_index',render_index.render_index);
	app.get('/render_test',render_test.render_test);
}
